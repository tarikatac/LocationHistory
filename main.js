...
async function stepstoExecute() {
  ...
  document.getElementById('start_posting').addEventListener('click', async () => {
    await GetCoordinates();
    await fetchLocations();
    document.getElementById('map').classList.remove('hidden');
    document.getElementById('start_posting').classList.add('hidden');
...
document.querySelector('#stop').addEventListener('click', () => {
  navigator.geolocation.clearWatch(locator);/*console.log(locator);console.log("stop button was pressed.");*/
